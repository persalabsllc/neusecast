...
export default function AdvertisingTermsPage() {
  return (
    <LegalPage eyebrow="For advertisers" title="Advertising Terms">
      <section><h2>The all-screen plan</h2><p>The $75 monthly plan includes approved campaigns on every compatible, active NeuseCast screen, subject to venue restrictions and network availability. The number and location of active screens may change as screens are added, serviced, or temporarily taken offline.</p></section>
