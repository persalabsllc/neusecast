...
export default async function ControlDashboard() {
  ...
  const [screenRows, campaignRows, creativeRows, advertiserRows, playRows, [newsroomReview]] = await Promise.all([
